    ...
    bool isEntrance = false;
        ...
        foreach (RoomNodeGraphSO roomNodeGraph in roomNodeGraphList)
        {
            ...
            foreach (RoomNodeSO roomNodeSO in roomNodeGraph.roomNodeList)
            {
                ...
                if (roomNodeSO.roomNodeType.isEntrance || roomNodeSO.roomNodeType.isCorridorEW || roomNodeSO.roomNodeType.isCorridor || roomNodeSO.roomNodeType.isCorridorNS || roomNodeSO.roomNodeType.isNone)
                    continue;
